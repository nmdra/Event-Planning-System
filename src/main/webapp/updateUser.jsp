    ...
    <form action="updateUser" method="POST" onsubmit="return ValidatePassword(document.getElementById('password'), document.getElementById('confirmPassword'));" class="col-md-7">
        ...
        <div class="form-row">
            <div class="form-group col-md-6">
                ...
                <input type="text" id="name" name="name" placeholder="Enter the Name" required class="form-control" value="<%= user.getName() %>"><br>
            </div>

            <div class="form-group col-md-6 ">
                <label for="username">Username</label><br>
                <input type="text" id="username" name="username" placeholder="Enter the Username" required class="form-control" value="<%= user.getUsername()%>"><br>
            </div>
        </div>
        ...
        <div class="form-row">
            <div class="form-group col-md-12">
                ...
                <input type="email" id="email" name="email" placeholder="Enter the Email" required class="form-control" value="<%= user.getEmail()%>"><br>
            </div>
        </div>
