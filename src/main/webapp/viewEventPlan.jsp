...
<div class="container">
  <h1>Event Plan</h1>
  <form action="viewEventPlan" method="post">
    ...
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="theme"  value="${eventPlan.theme}" name="theme" readonly>
    </div>
    <div class="form-group">
      <label for="budget">Budget:</label>
      <input type="text" class="form-control" id="budget" name="budget" value="Rs.${eventPlan.budget}" readonly>
    </div>
    <div class="form-group">
